        ...
        <ComposedChart data={data} margin={{ top: 12, right: 8, left: -18, bottom: 0 }}>
          <defs>
            ...
            <linearGradient id="dashboardBarFill" x1="0" y1="0" x2="0" y2="1">
              <stop offset="0%" stopColor={colors.secondary} stopOpacity={0.42} />
          ...
          <YAxis
            ...
            domain={[0, 100]}
          />
          <YAxis yAxisId="count" orientation="right" hide domain={[0, 'dataMax + 1']} />
          <Tooltip content={<DashboardTooltip />} cursor={{ stroke: colors.grid, strokeWidth: 1 }} />
          <Bar
            yAxisId="count"
            dataKey="count"
            name="Predictions"
